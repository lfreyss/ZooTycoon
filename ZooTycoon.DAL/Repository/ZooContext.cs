...
namespace ZooTycoon.DAL.Repository
{
    public class ZooContext
    {
        ...
        public List<Spectacle> listSpectacle { get; set; }
        public List<Animateur> listAnimateur { get; set; }
        ...
        public ZooContext()
        {
            ...
            List<Enclos> listEnclos = new List<Enclos>()
            {
                ...
                new Enclos("EnclosHuitreSpectacle", 10,"Spectacle", listHuitre, null),
                new Enclos("EnclosBaleine", 100,"Habitat", listBaleine, null),
                new Enclos("EnclosBaleineSpectacle", 100,"Spectacle", listBaleine, null),
            };

            this.listEnclos = listEnclos;


            List<Animateur> listAnimateur = new List<Animateur>()
            {
                new Animateur("AnimateurBob", 42, 000000000, true, listHuitre[0]),
                new Animateur("AnimateurMarley", 25, 000000000, true, listBaleine[1]),
            };

            this.listAnimateur = listAnimateur;


            List<Spectacle> listSpectacle = new List<Spectacle>()
            {
                new Spectacle("SpectacleHuitre", new DateTime(2017,09,12,10,0,0), listEnclos[1], new List<Animateur> { listAnimateur[0], listAnimateur[1] }),
                new Spectacle("SpectacleBaleine", new DateTime(2017,09,12,16,0,0), listEnclos[1], new List<Animateur> { listAnimateur[0] }),
            };
